...
def plot_training_curves(data):
    ...
    # 保存
    output_path = '/home/wzj/pan1/contour_deep/scripts/logs/retrieval_baseline_day8/training_curves_from_logs.png'
    os.makedirs('/home/wzj/pan1/contour_deep/scripts/logs/retrieval_baseline_day8', exist_ok=True)
