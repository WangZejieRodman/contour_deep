...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str,
                        default='/home/wzj/pan1/contour_deep/configs/config_base.yaml',
                        help='Base config file')
    parser.add_argument('--train_config', type=str,
                        default='/home/wzj/pan1/contour_deep/configs/config_retrieval.yaml',
                        help='Training config file')
    parser.add_argument('--train_pickle', type=str,
                        default='/home/wzj/pan1/contour_deep/data/test_queries_chilean_period.pickle',
